...
class RNFiscalXMLDocument(Base):
    ...
    uuid_sat = Column(String, nullable=True)
    ...
    cfdi_usage = Column(String, nullable=True)
    issuer_tax_regime = Column(String, nullable=True)
    receiver_tax_regime = Column(String, nullable=True)

    subtotal = Column(String, nullable=True)
    discount = Column(String, nullable=True)
    total = Column(String, nullable=True)
    currency = Column(String, nullable=True)
    tax_transferred_total = Column(String, nullable=True)
    tax_withheld_total = Column(String, nullable=True)
